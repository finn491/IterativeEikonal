"""
    ...
    Compute the cost function from the R^2-vesselness.
    In particular, provides the `CostR2` class, which can compute the cost
    function from a vesselness on R^2 and store it with its parameters.
"""
